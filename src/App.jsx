...
const UI_TRANSLATIONS = {
  ...
  "跨域智能体认证": "Cross-Domain Agent Authentication",
  "Token tunnel保障": "Token Tunnel Assurance",
  "确定性体验": "Deterministic Experience",
  "跨域智能体协作": "Cross-Domain Agent Collaboration",
  "机器狗通知机械臂开始协作": "Robot dog asks the robotic arm to collaborate",
  "机器狗前往交接区域": "Robot dog moves to the handover area",
  "机械臂交接快递给机器狗": "Robotic arm hands the parcel to the robot dog",
  "机器狗交付": "Robot dog delivers the parcel",
