  ...
  2: {
    auth: {
      ...
      lines: [
        ...
        { key: "SRF->SystemAgent", latencyMs: latency(3, 6) },
        { key: "SystemAgent->IDM", latencyMs: latency(4, 8) },
        { key: "SystemAgent->ACN", latencyMs: latency(4, 8) },
        { key: "SystemAgent->ConnectionAgent", latencyMs: latency(5, 10) },
      ],
    },
  },
  3: {
  ...
  4: {
    domain: {
      ...
      lines: [
        ...
        { key: "SRF->SystemAgent", latencyMs: latency(3, 6) },
        { key: "SystemAgent->ACN", latencyMs: latency(5, 10) },
        { key: "ACN->DCF", latencyMs: latency(3, 7) },
        { key: "DCF->DSF", latencyMs: latency(2, 5) },
        { key: "ACN->IDM", latencyMs: latency(3, 7) },
      ],
    },
  },
  5: {
  ...
  6: {
    a2aGateway: {
      ...
      lines: [
        ...
        { key: "AgentGW->OttAgentGW", latencyMs: latency(4, 8) },
        { key: "OttAgentGW->MarketAgent", latencyMs: latency(4, 8) },
      ],
    },
    a2aTrust: {
      color: "#f472b6",
  ...
  7: {
    computeSandbox: {
      ...
      lines: [
        ...
        { key: "gNB->SRF", latencyMs: latency(7, 13) },
        { key: "SRF->SystemAgent", latencyMs: latency(3, 6) },
        { key: "SystemAgent->Computing", latencyMs: latency(6, 12) },
      ],
    },
  },
  8: {
  ...
  10: {
    handoff: {
      ...
      lines: [
        ...
        { key: "AgentGW->OttAgentGW", latencyMs: latency(5, 10) },
        { key: "OttAgentGW->MarketAgent", latencyMs: latency(5, 10) },
      ],
    },
  },
};
